...
// --- KOMPONEN MASKOT SVG (BIPBOP 2.0 - FUTURISTIK) ---
const BipBopMascot = ({ mood }) => {
  const getThemeColor = () => {
    if (mood === 'gameover' || mood === 'timeout') return '#ff1744'; 
    if (mood === 'happy' || mood === 'excited' || mood === 'start' || mood === 'result') return '#00e676'; 
    if (mood === 'sad') return '#2979ff'; 
      ...
      <g className="transition-transform duration-500 hover:-translate-y-2">
        ...
        <g filter="url(#neonGlow)" fill="none" stroke={theme} strokeWidth="3.5" strokeLinecap="round">
          {(mood === 'happy' || mood === 'excited' || mood === 'start' || mood === 'result') ? (
            <><path d="M 45 52 Q 50 44 55 52" /><path d="M 65 52 Q 70 44 75 52" /><path d="M 52 64 Q 60 70 68 64" strokeWidth="2.5" /></>
          ) : mood === 'sad' ? (
            <><line x1="45" y1="48" x2="55" y2="52" /><line x1="65" y1="52" x2="75" y2="48" /><path d="M 55 68 Q 60 63 65 68" strokeWidth="2.5" /></>
          ) : mood === 'memorize' ? (
            <><circle cx="50" cy="52" r="4.5" fill="none" strokeWidth="2" /><circle cx="70" cy="52" r="4.5" fill="none" strokeWidth="2" /><circle cx="50" cy="52" r="1.5" fill={theme} stroke="none" /><circle cx="70" cy="52" r="1.5" fill={theme} stroke="none" /><line x1="42" y1="65" x2="78" y2="65" strokeWidth="1.5" strokeDasharray="3,3" opacity="0.8" /></>
          ) : (mood === 'gameover' || mood === 'timeout') ? (
            <><path d="M 46 48 L 54 56 M 54 48 L 46 56" strokeWidth="3" /><path d="M 66 48 L 74 56 M 74 48 L 66 56" strokeWidth="3" /><line x1="50" y1="66" x2="70" y2="66" strokeWidth="2.5" strokeDasharray="2,3" /></>
          ) : (
            <><circle cx="50" cy="52" r="3.5" fill={theme} stroke="none" /><circle cx="70" cy="52" r="3.5" fill={theme} stroke="none" /><line x1="55" y1="65" x2="65" y2="65" strokeWidth="2" /></>
          )}
        </g>
      </g>
    </svg>
